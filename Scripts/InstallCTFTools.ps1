...
$source = 'https://github.com/HankBoone/CTFTools/blob/main/Installers/burpsuite_community_windows-x64_v2021_12_1.exe'
...
$source = 'https://github.com/HankBoone/CTFTools/blob/main/Installers/metasploitframework-latest.msi'
...
$source = 'https://github.com/HankBoone/CTFTools/blob/main/Installers/Wireshark-win64-3.6.1.exe'
...
$source = 'https://github.com/HankBoone/CTFTools/blob/main/Installers/nmap-7.92-setup.exe'
